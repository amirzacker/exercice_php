            ...
            <div class="col mb-5">
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <?php
                        $sqlRequestcommentP = "SELECT AVG(start_comment) FROM comment where  id_article ='" . $value_articles['id_article'] . "' ";
                        $article_tableP = mysqli_query($connexion, $sqlRequestcommentP);
                        $resultat_commentP = mysqli_fetch_all($article_tableP, MYSQLI_ASSOC);
                        ?>


                        <div> NOTE DE L'ARTCILE
                        <?php foreach ($resultat_commentP as $key_commentP => $value_commentP) { ?>
                            <?php
                                    switch (intval($value_commentP['AVG(start_comment)'])) {
                                        case 1:
                                            echo (" ☆");
                                            break;
                                        case 2:
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            ...
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="http://localhost/php/exercice/fiche_article/index.php?id_article=<?php echo $value_articles['id_article']; ?>">Voir detail</a></div>
                        </div>
                    </div>
                </div>
